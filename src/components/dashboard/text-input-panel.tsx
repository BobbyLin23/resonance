...
export function TextInputPanel() {
  ...
  return (
    <div className="rounded-[22px] bg-linear-185 from-[#ff8ee3] from-15% via-[#57d7e0] via-39% to-[#dbf1f2] to-85% p-0.5 shadow-[0_0_0_4px_var(--background)]">
      ...
      <div className="rounded-[20px] bg-muted p-1">
        <div className="space-y-4 rounded-2xl bg-card p-4 drop-shadow-xs">
          <Textarea
            ...
            className="min-h-35 resize-none border-0 bg-transparent p-0.5 shadow-none focus-visible:ring-0"
            value={text}
